/*
 * Forked from:
 * https://github.com/ReVanced/revanced-patches/blob/377d4e15016296b45d809697f7f69bce74badd3a/patches/src/main/kotlin/app/revanced/patches/tiktok/interaction/cleardisplay/RememberClearDisplayPatch.kt
 */
...
val rememberClearDisplayPatch = bytecodePatch(
    ...
    description = "Remembers the clear display configurations in between videos. (Supports TikTok 43.8.3 only.)",
) {
